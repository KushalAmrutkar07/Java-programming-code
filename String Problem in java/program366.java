...
class DBMS
{
 ...
 // select * from student
   public void StartDBMS()
   {
      ...
      System.out.println("Kushal customised DBMS started successFully...");
      String Query = "";   
         ...
         if("Help".equals(token[0]))
          {
            ...
            {
                    System.out.println("Thank you for using Kushal DBMS");
                    break;
...
class program366
{
   public static void main(String arg[])
   {
     ...
     /* dobj.StartDBMS();
      dobj.InsertData("Kushal",1000);       
      dobj.InsertData("Pratik",3000);
      dobj.InsertData("Sachin",2000);
      dobj.InsertData("Atharva",4000);
      dobj.InsertData("priya",8000);
      dobj.InsertData("Aniket",9000);
                  

  
       //dobj.DisplaySpecific(2);
       //dobj.DisplaySpecific("Kushal");    
      
     // dobj.DeleteSpecific(2);
     // dobj.DeleteSpecific("Kushal");
